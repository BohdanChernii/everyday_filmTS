...
export const moviesService = {
  ...
  getBySearchParams: (page: number | string | null, search: string): AxiosRes<IMovie[]> => axiosService(`${baseURL}${urls.search}/?page=${page}&query=${search}`),

  getPopular: (): AxiosRes<IMovie[]> => axiosService(`${baseURL}${urls.trending}`)
